...
export async function registerNodejs(): Promise<void> {
  ...
  const [
    ...
    { startVirtualCatalogRegenerationScheduler },
    { getSettings },
    ...
    import("@/shared/services/virtualCatalogScheduler"),
  ...
  if (!isBackgroundServicesDisabled()) {
    ...
    startVirtualCatalogRegenerationScheduler();
    console.log("[STARTUP] Virtual catalog regeneration scheduler started");
