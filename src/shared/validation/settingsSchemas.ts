...
export const updateSettingsSchema = z.object({
  ...
  freeProxyAutoJobEnabled: z.boolean().optional(),
  freeProxyCheckIntervalMin: z.number().int().min(1).max(1440).optional(),
  freeProxySyncIntervalMin: z.number().int().min(1).max(1440).optional(),
  freeProxyCountryFilter: z.string().max(10).optional(),
  freeProxyMinQuality: z.number().int().min(0).max(100).optional(),
  freeProxyMinTests: z.number().int().min(1).max(100).optional(),
  freeProxyMinSuccessRate: z.number().int().min(0).max(100).optional(),
  freeProxyAutoElevate: z.boolean().optional(),
