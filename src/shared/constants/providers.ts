...
// No-auth Providers
// NOAUTH_PROVIDERS data lives in ./providers/noauth (imported above); the duplicate inline literal here was pre-existing merge damage (removed).

export const FREE_APIKEY_PROVIDER_IDS = new Set(["qoder", "opencode"]);
...
// WEB_COOKIE_PROVIDERS data lives in ./providers/web-cookie (imported above); the duplicate inline literal here was pre-existing merge damage (removed).

// API Key Providers
// APIKEY_PROVIDERS data lives in ./providers/apikey (imported above); the duplicate inline literal here was pre-existing merge damage (removed).
...
// LOCAL_PROVIDERS data lives in ./providers/local (imported above); the duplicate inline literal here was pre-existing merge damage (removed).
