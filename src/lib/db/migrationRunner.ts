...
// RENAMED_MIGRATION_COMPATIBILITY, LEGACY_VERSION_SLOT_MIGRATIONS,
// SUPERSEDED_DUPLICATE_MIGRATIONS, PHYSICAL_SCHEMA_SENTINELS,
// INITIAL_SCHEMA_SENTINELS, and OPTIONAL_FTS5_MIGRATION_VERSIONS now live in
// ./migrationRunner/constants (imported above); the duplicate inline literals
// here were pre-existing merge damage. RENAMED_MIGRATION_COMPATIBILITY had
// drifted (3 entries added here after the split were missing from the split
// file) — synced there before removing this copy.
